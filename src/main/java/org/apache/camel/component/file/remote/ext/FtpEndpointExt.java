...
public class FtpEndpointExt<T extends FTPFile> extends FtpEndpoint<T> {
    ...
    public FtpEndpointExt(String uri, RemoteFileComponent<FTPFile> component, FtpConfiguration configuration) {
	...
	protected FTPClient createFtpClient() throws Exception {
		...
		if(proxyUrl != null) {
			...
			String[] proxyParams = proxyUrl.split(":");
			client.setProxy(new Proxy(Type.HTTP, new InetSocketAddress(proxyParams[0], 
					Integer.parseInt(proxyParams[1]))));
		}
		return client;
	}
}
